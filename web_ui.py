...
DEFAULT_CKPT_PATH = '/data/ggf/ChatXRay/output_qwen'
...
def _load_model_tokenizer(args):
    ...
    #     "/data/ggf/ChatXRay/qwen")
    #tokenizer = AutoTokenizer.from_pretrained("~/.cache/huggingface/hub/models--qwen--Qwen-VL-Chat/snapshots/f57cfbd358cb56b710d963669ad1bcfb44cdcdd8", trust_remote_code=True)
    if args.cpu_only:
        device_map = "cpu"
    else:
        device_map = "cuda"
...
Revision=master&FilePath=assets/logo.jpeg&View=true" style="height: 80px"/><p>""")
        gr.Markdown("""<center><font size=8>ChatXRay</center>""")
        gr.Markdown(
            """\
<center><font size=3>This WebUI is based on Qwen-VL-Chat, developed by Alibaba Cloud. \
(本WebUI基于Qwen-vl-7b微调，实现大模型写X光报告功能。)</center>""")
        gr.Markdown("""\
